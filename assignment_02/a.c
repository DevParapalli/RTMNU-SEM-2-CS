...
void print_name_on_yoj(student s[MAX_LENGTH], int yoj, int num_students) {
    int i;
...
void print_data_on_roll_number(student s[MAX_LENGTH], int roll_number, int num_students) {
    int i;
    for (i = 0; i < num_students; i++) {
